...
def bench_test(tol_scf, mesh_spacing, atomAmount, name):       
...
if __name__ == "__main__":
    ...
    Ebench, Fbench = bench_test(1e-5, 0.15, atomNumber, name) # TOL_SCF, MESH_SPACING

    tolscf_list = [5e-4, 1e-3, 3e-3]
    mesh_list = [0.3, 0.4, 0.5]
